...
const EDGE = '#FD0167';         // the artwork's hottest crimson, sampled from the
                                // graded palette -- grade.py cools every red onto
                                // the Crimson Moon axis, so the old #FF2D3C was
                                // left behind as the one warm thing in the picture
